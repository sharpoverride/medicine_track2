...
namespace MedicineTrack.Medication.Migrations.Migrations
{
    ...
    [Migration("20251221144259_Net10Upgrade")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedicineTrack.Medication.Data.Models.Medication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MedicineTrack.Medication.Data.Models.MedicationLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MedicineTrack.Medication.Data.Models.Medication", b =>
                {
                    b.OwnsMany("MedicineTrack.Medication.Data.Models.Schedule", "Schedules", b1 =>
                        {
            ...
            modelBuilder.Entity("MedicineTrack.Medication.Data.Models.MedicationLog", b =>
                {
                    b.HasOne("MedicineTrack.Medication.Data.Models.Medication", null)
                        .WithMany()
                        .HasForeignKey("MedicationId")
